  ...
  return (
    <Card className="shadow-2xl border-0 bg-white dark:bg-black/80 backdrop-blur-lg animate-slide-in-right max-w-3xl mx-auto my-10">
      ...
      <CardContent className="text-left space-y-4 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
        ...
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">What are cookies?</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Why does Wyra use cookies?</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Types of cookies we use:</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Your choices:</h3>
        <p>
        ...
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Got questions?</h3>
        <p>
