...
export default function FollowButton({
  ...
  <Button
      ...
      disabled={loading}
      className={`px-2 py-0 h-8 text-sm text-white dark:text-black rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none ${
        isFollowing
